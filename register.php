...
if (@$_POST['submit'])
{
    ...
    $data_users = array(
        ...
        ':user_imgprofile' => 'sarawut.jpg',
        ':user_role'       => 'user',
        ':user_created_at' => date('Y-m-d H:i:s'),
        ':user_status'     => '1',
    );

    $result = $connect->prepare("INSERT INTO users(user_fullname,user_email,user_password,user_imgprofile,user_role,user_created_at,user_status)
 VALUES (:user_fullname,:user_email,:user_password,:user_imgprofile,:user_role,:user_created_at,:user_status)");
