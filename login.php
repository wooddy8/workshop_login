...
if (@$_POST['submit'])
{
    ...
    $result = $connect->prepare("SELECT user_email,user_password FROM users WHERE user_email=:user_email LIMIT 1");
    ...
    if ($result->rowCount())
    {
        ...
        {
            $msg = "<div class='alert alert-danger'>ข้อมูลเข้าระบบไม่ถูกต้อง กรุณาลองใหม่</div>";
        }
    }
    else
    {
